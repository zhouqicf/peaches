...
POM.prototype = {
     ...
     * @return {Array} 属性值列表
     */
    getPropertyValue: function (selector, prop) {
        'use strict';
        this._action();
        var rule;
        ...
        for (i = 0, len = rule.declarations.length; i < len; i++) {
    ...
    setPropertyValue: function (selector, prop, value) {
        'use strict';
        this._action();
    },
    removeProperty: function (selector, prop) {
        'use strict';
        this._action();
    },
