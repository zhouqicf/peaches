...
var trimAll = require('./tools').trimAll;
...
Merger.prototype = {
    ...
    countSelectors: function () {
        ...
        this.styleSheet.cssRules.forEach(function (cssRule) {
            // 如果是CSS function 如 CSSKeyframeRule ：http://www.w3schools.com/cssref/css3_pr_keyframes.asp
            // FIXME: 更准确的描述
